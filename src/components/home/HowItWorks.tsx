...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Get matched with skilled developers who align with your project needs.'
  },
  {
    icon: Code,
    title: 'Development',
    description: 'Work collaboratively to bring your idea to life with expert guidance.'
  },
  {
    icon: Rocket,
    title: 'Launch',
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-600">Simple steps to transform your idea into reality</p>
        </div>
