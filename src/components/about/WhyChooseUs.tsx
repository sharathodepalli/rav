...
const REASONS = [
  ...
  {
    title: 'Perfect Match',
    description: 'Our platform ensures the right developers for your specific project needs.',
    icon: Puzzle
  },
  {
    title: 'Collaborative Approach',
    description: 'We foster strong partnerships between innovators and developers.',
    icon: Users
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-500">
            With a commitment to innovation and collaboration, we provide a platform where visionaries 
            and developers come together to create impactful solutions.
          </p>
        </div>
